...
// anlamlı kalsın diye.
$swSrc = oku('sw.js');
ok('sw.js: CACHE_NAME ve APP_SURUM sürümü v238',
    str_contains($swSrc, "const CACHE_NAME = 'yukleme-plani-v238';")
    && str_contains(oku('config/helpers.php'), "define('APP_SURUM', 'v238');"));
