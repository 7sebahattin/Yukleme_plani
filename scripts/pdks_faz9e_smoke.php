...
ok9e('config/helpers.php: APP_SURUM v245', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v245['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v245'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v245', str_contains(oku9e('sw.js'), 'yukleme-plani-v245'));
