...
ok9e('config/helpers.php: APP_SURUM v260', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v260['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v260'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v260', str_contains(oku9e('sw.js'), 'yukleme-plani-v260'));
