...
ok9e('config/helpers.php: APP_SURUM v256', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v256['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v256'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v256', str_contains(oku9e('sw.js'), 'yukleme-plani-v256'));
