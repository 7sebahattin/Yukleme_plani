...
ok9e('config/helpers.php: APP_SURUM v254', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v254['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v254'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v254', str_contains(oku9e('sw.js'), 'yukleme-plani-v254'));
