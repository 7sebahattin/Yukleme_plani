...
ok9e('config/helpers.php: APP_SURUM v232', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v232['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v232'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v232', str_contains(oku9e('sw.js'), 'yukleme-plani-v232'));
