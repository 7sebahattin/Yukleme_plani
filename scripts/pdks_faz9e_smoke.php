...
ok9e('config/helpers.php: APP_SURUM v248', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v248['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v248'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v248', str_contains(oku9e('sw.js'), 'yukleme-plani-v248'));
