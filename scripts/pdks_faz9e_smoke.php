...
ok9e('config/helpers.php: APP_SURUM v239', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v239['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v239'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v239', str_contains(oku9e('sw.js'), 'yukleme-plani-v239'));
