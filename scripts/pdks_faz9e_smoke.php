...
ok9e('config/helpers.php: APP_SURUM v257', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v257['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v257'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v257', str_contains(oku9e('sw.js'), 'yukleme-plani-v257'));
