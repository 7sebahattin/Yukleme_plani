...
ok9e('config/helpers.php: APP_SURUM v241', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v241['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v241'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v241', str_contains(oku9e('sw.js'), 'yukleme-plani-v241'));
