...
ok9e('config/helpers.php: APP_SURUM v244', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v244['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v244'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v244', str_contains(oku9e('sw.js'), 'yukleme-plani-v244'));
