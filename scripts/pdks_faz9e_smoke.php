...
ok9e('config/helpers.php: APP_SURUM v261', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v261['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v261'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v261', str_contains(oku9e('sw.js'), 'yukleme-plani-v261'));
