...
ok9e('config/helpers.php: APP_SURUM v242', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v242['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v242'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v242', str_contains(oku9e('sw.js'), 'yukleme-plani-v242'));
