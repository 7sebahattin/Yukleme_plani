...
ok9e('config/helpers.php: APP_SURUM v259', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v259['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v259'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v259', str_contains(oku9e('sw.js'), 'yukleme-plani-v259'));
