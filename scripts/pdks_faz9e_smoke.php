...
ok9e('config/helpers.php: APP_SURUM v255', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v255['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v255'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v255', str_contains(oku9e('sw.js'), 'yukleme-plani-v255'));
