...
ok9e('config/helpers.php: APP_SURUM v240', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v240['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v240'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v240', str_contains(oku9e('sw.js'), 'yukleme-plani-v240'));
