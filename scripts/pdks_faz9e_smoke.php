...
ok9e('config/helpers.php: APP_SURUM v234', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v234['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v234'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v234', str_contains(oku9e('sw.js'), 'yukleme-plani-v234'));
