...
ok9e('config/helpers.php: APP_SURUM v238', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v238['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v238'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v238', str_contains(oku9e('sw.js'), 'yukleme-plani-v238'));
