...
ok9e('config/helpers.php: APP_SURUM v258', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v258['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v258'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v258', str_contains(oku9e('sw.js'), 'yukleme-plani-v258'));
