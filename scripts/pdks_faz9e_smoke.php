...
ok9e('config/helpers.php: APP_SURUM v243', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v243['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v243'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v243', str_contains(oku9e('sw.js'), 'yukleme-plani-v243'));
