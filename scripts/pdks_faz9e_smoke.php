...
ok9e('config/helpers.php: APP_SURUM v233', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v233['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v233'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v233', str_contains(oku9e('sw.js'), 'yukleme-plani-v233'));
