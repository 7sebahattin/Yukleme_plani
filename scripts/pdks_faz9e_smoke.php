...
ok9e('config/helpers.php: APP_SURUM v247', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v247['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v247'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v247', str_contains(oku9e('sw.js'), 'yukleme-plani-v247'));
