...
ok9e('config/helpers.php: APP_SURUM v249', (bool)preg_match("/APP_SURUM['\"]?\\s*,?\\s*['\"]v249['\"]/", $helpersSrc) || str_contains($helpersSrc, "'v249'"));
ok9e('sw.js: CACHE_NAME yukleme-plani-v249', str_contains(oku9e('sw.js'), 'yukleme-plani-v249'));
