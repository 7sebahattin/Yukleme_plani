        ...
        $this->pdo->prepare(
            "INSERT INTO hks_notifications
                (local_no, source_type, source_id, direction, notification_type, sifat,
                 ...
                 karsi_kisi_verified, karsi_kisi_verified_at, karsi_kisi_query_json,
                 karsi_kisi_hks_unvan, karsi_kisi_hks_id, karsi_kisi_hks_sifatlari_json, karsi_kisi_kayitli_degil,
                 reference_kunye_verified, reference_kunye_verified_at, reference_kunye_query_json,
                 reference_kunye_kalan_miktar, reference_kunye_urun, reference_kunye_urun_cinsi, reference_kunye_birim,
            ...
            (int)($data['karsi_kisi_verified'] ?? 0),
            $data['karsi_kisi_verified_at'] ?? null,
            $data['karsi_kisi_query_json'] ?? null,
            $data['karsi_kisi_hks_unvan'] ?? null,
            $data['karsi_kisi_hks_id'] ?? null,
            $data['karsi_kisi_hks_sifatlari_json'] ?? null,
            (int)($data['karsi_kisi_kayitli_degil'] ?? 0),
            (int)($data['reference_kunye_verified'] ?? 0),
            $data['reference_kunye_verified_at'] ?? null,
            $data['reference_kunye_query_json'] ?? null,
            ($data['reference_kunye_kalan_miktar'] ?? '') !== '' ? (float)$data['reference_kunye_kalan_miktar'] : null,
            $data['reference_kunye_urun'] ?? null,
            $data['reference_kunye_urun_cinsi'] ?? null,
            $data['reference_kunye_birim'] ?? null,
